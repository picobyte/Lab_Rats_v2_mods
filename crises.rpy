...
label quitting_crisis_label(the_person): #The person tries to quit, you have a chance to keep her around for a hefty raise (Or by fucking her, if her sluttiness is high enough).
    ...
    if the_person.happiness < 100:
        the_person.name "I've been doing my best to keep my head up lately, but honestly I just have been hating working here. I've decided that today is going to be my last day."
    elif the_person.salary < the_person.calculate_base_salary():
        the_person.name "I've been looking into other positions, and the pay I'm recieving here just isn't high enough. I've decided to accept another offer; today will be my last day."
    else:
        the_person.name "I've been looking for a change in my life, and I feel like this job is holding me back. I've decided that today is going to be my last day."
    
    $ raise_amount = int(the_person.salary*0.1)
    menu:
        "Offer a 10%% raise. (+$[raise_amount]/day)":
            ...
            if the_person.get_job_happiness_score() >= 0: #The raise has made them happy with the job.
                ...
                show screen float_up_screen(["+$[raise_amount]/day Salary"],["float_text_green"])
                mc.name "Excellent, I'll have it on the books by the end of the day. Thank you for all your hard work [the_person.name]."
        ...
        "Make her cum to convince her to stay." if the_person.effective_sluttiness() > 60:
            ...
            if the_person.arousal > 100: #If you made them cum, they'll stay on for a little while.
                ...
                the_person.name "I'm sorry [mc.name], but I haven't changed my mind. I'll clear out my desk and be gone by the end of the day."
                "[the_person.name] takes a moment to put herself back together, then steps out of your office."
                $ mc.business.remove_employee(the_person)
            $ the_person.reset_arousal()
        ...
        "Let them go.":
            ...
            the_person.name "I'm glad you understand. I'll clear out my desk and be gone by the end of the day."
        ...
        menu:
            ...
            "Test the serum on [rd_staff.name].":
                ...
                if rd_staff.obedience < 80:
                    ...
                    menu:
                        "Give [rd_staff.name] a %%10 raise. (+$[raise_amount]/day)":
                            show screen float_up_screen(["+$[raise_amount]/day Salary"],["float_text_green"])
